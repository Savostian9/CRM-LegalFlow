      ...
      <form @submit.prevent="save" class="modal-body">
        <div class="grid">
          ...
          <label>
            ...
            <input type="text" v-model="form.location" :placeholder="$t('tasks.form.locationPH')" />
          </label>
        ...
        <footer class="footer">
          <button type="button" class="btn danger" v-if="task" @click="showDeleteConfirm=true">{{ $t('common.delete') }}</button>
