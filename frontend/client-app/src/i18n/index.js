...
const messages = {
  ...
  usernameTitle: 'Допустимы буквы, цифры и символы . ＠ + - _',
      ...
      permissions: {
        access: 'Доступ',
        permissionsForAll: 'Права для всех',
        title: 'Доступ пользователя',
        description: 'Отметьте действия, которые этому сотруднику разрешено выполнять.',
        bulkTitle: 'Массовое применение прав',
        bulkDescription: 'Отметьте права, которые нужно применить ко всем сотрудникам компании (владельца можно включить ниже).',
        clients: 'Клиенты',
        casesFiles: 'Дела и файлы',
        tasks: 'Задачи',
        admin: 'Администрирование',
        createClients: 'Создание клиентов',
        editClients: 'Редактирование клиентов',
        deleteClients: 'Удаление клиентов',
        createCases: 'Создание дел',
        editCases: 'Редактирование дел',
        deleteCases: 'Удаление дел',
        uploadFiles: 'Загрузка и удаление файлов',
        ...
        ownerWarning: 'Владельца нельзя менять.',
        includeOwner: 'Включить владельца',
        save: 'Сохранить',
        apply: 'Применить',
        cancel: 'Отмена'
      }
  ...
  usernameTitle: 'Dozwolone litery, cyfry oraz znaki . ＠ + - _',
      ...
      permissions: {
        access: 'Dostęp',
        permissionsForAll: 'Uprawnienia dla wszystkich',
        title: 'Dostęp użytkownika',
        description: 'Zaznacz działania, które ten pracownik może wykonywać.',
        bulkTitle: 'Masowe przypisanie uprawnień',
        bulkDescription: 'Zaznacz uprawnienia, które mają zostać przypisane wszystkim pracownikom firmy (właściciela można dodać poniżej).',
        clients: 'Klienci',
        casesFiles: 'Sprawy i pliki',
        tasks: 'Zadania',
        admin: 'Administracja',
        createClients: 'Tworzenie klientów',
        editClients: 'Edycja klientów',
        deleteClients: 'Usuwanie klientów',
        createCases: 'Tworzenie spraw',
        editCases: 'Edycja spraw',
        deleteCases: 'Usuwanie spraw',
        uploadFiles: 'Przesyłanie i usuwanie plików',
        createTasks: 'Tworzenie zadań',
        editTasks: 'Edycja zadań',
        deleteTasks: 'Usuwanie zadań',
        createInvites: 'Tworzenie zaproszeń',
        manageUsers: 'Zarządzanie użytkownikami',
        manageSubscription: 'Zarządzanie subskrypcją',
        ownerWarning: 'Właściciela nie można zmienić.',
        includeOwner: 'Dołącz właściciela',
        save: 'Zapisz',
        apply: 'Zastosuj',
        cancel: 'Anuluj'
      }
